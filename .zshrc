...
function myip() {
     ...
     ifconfig wlp0s20f3 | grep 'inet ' | sed -e 's/:/ /' | awk '{print "en0 (IPv4): " $2 " " $3 " " $4 " " $5 " " $6}'
...
export PATH=/opt/node/bin:/home/cybercritter/bin:/home/cybercritter/.venv/bin:/home/cybercritter/.local/bin:/opt/python/3.12.0/bin:/home/cybercritter/bin:/opt/gradle/bin:/usr/local/bin:/home/cybercritter/.local/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games:/usr/local/games:/snap/bin
